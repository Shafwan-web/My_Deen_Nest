...
const ProgressReport = () => {
  ...
  const percentage = 88; // 🔹 set your value here
  ...
  return (
    <div>
      <div className="grid grid-cols-[100%] lg:grid-cols-[30%_70%] gap-4 pe-4 pb-4">
        <div className="overall-performance flex flex-col items-center bg-white rounded-md ">
          ...
          <p className="font-primary">Academic Progress</p>
          <div className="flex flex-row lg:flex-col w-full  justify-center items-center p-2 font-primary">
          ...
          <div className="w-full   rounded-md">
            ...
            <div className="grid grid-cols-1  bg-white gap-4  p-4">
              {studentsData.map((item) => (
                <div
                  key={item.id}
                  className="p-4 border border-[#F2F2F2] rounded-lg font-primary"
                >
                  <div className="flex justify-between ">
                    ...
                    <h3 className="font-semibold text-[#008000]">
                      {item.grade}
                    </h3>
                  </div>
                  ...
                  <div className="flex items-center justify-between font-semibold text-xs mt-2">
                    <p className="text-sm  font-semibold">
                      {item.maulana}
                    </p>
                    <p>{item.progress}% Progress</p>
                  </div>
                </div>
              ))}
            </div>
